...
// Проверка позиций на вхождение в массив
    ...
    {
        //Напишите свое решение здесь
        if (x - 1 <= array.GetLength(0) && y - 1 <= array.GetLength(1)) return true;
        else return false;
    }
    ...
    public static void PrintResult(int[,] numbers, int x, int y)
    {
        ...
        {
            System.Console.Write(FindElementByPosition(numbers, x, y));
        }
        else System.Console.Write("Позиция по рядам выходит за пределы массива");
    }
}
